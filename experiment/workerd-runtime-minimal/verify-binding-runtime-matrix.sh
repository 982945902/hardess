...
run_case() {
  ...
  (
    ...
    assert_json_field "$get_response" --path routeDispatchMode --equals "http_handler"
    ...
    assert_json_field "$post_response" --path routePathPrefix --equals "/echo"
    assert_json_field "$post_response" --path routeActionKind --equals "http"
    ...
    assert_json_field "$ws_upgrade_required_response" --path routePathPrefix --equals "/ws"
    assert_json_field "$ws_upgrade_required_response" --path actionId --equals "ws.echo"
    assert_json_field "$ws_upgrade_required_response" --path routeActionKind --equals "websocket"
    assert_json_field "$ws_upgrade_required_response" --path routeDispatchMode --equals "websocket_builtin"
    ...
    assert_json_field "$ws_response" --path routePathPrefix --equals "/ws"
    assert_json_field "$ws_response" --path actionId --equals "ws.echo"
    assert_json_field "$ws_response" --path routeActionKind --equals "websocket"
    assert_json_field "$ws_response" --path routeDispatchMode --equals "websocket_builtin"
    ...
    assert_json_field "$runtime_response" --path routes.2.routeDispatchMode --equals "websocket_builtin"
