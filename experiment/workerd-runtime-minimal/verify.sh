...
WS_INVALID_METHOD_BODY="$(mktemp -t workerd-ws-invalid-method.XXXXXX)"
...
WS_INVALID_METHOD_STATUS="$(curl -sS -o "$WS_INVALID_METHOD_BODY" -w '%{http_code}' -X POST "$BASE_URL/ws")"
WS_INVALID_METHOD_RESPONSE="$(cat "$WS_INVALID_METHOD_BODY")"
...
grep -q 'name = "worker-route-contract.ts"' "$GENERATED_CONFIG"
...
assert_json_field "$RUNTIME_SUMMARY" --path routes.0.routePathPrefix --equals "/"
assert_json_field "$RUNTIME_SUMMARY" --path routes.0.routeActionKind --equals "http"
...
assert_json_field "$RESOLVED_MODEL" --path routeViews.0.routePathPrefix --equals "/"
assert_json_field "$RESOLVED_MODEL" --path routeViews.0.routeActionKind --equals "http"
...
assert_json_field "$RESOLVED_MODEL" --path compatibilityRouteTable.0.pathPrefix --equals "/"
assert_json_field "$RESOLVED_MODEL" --path compatibilityRouteTable.0.actionKind --equals "http"
...
assert_json_field "$RESOLVED_MODEL" --path compatibilityProtocolPackage.protocol --equals "workerd-http-ingress"
assert_json_field "$RESOLVED_MODEL" --path compatibilityProtocolPackage.version --equals "v1"
assert_json_field "$RESOLVED_MODEL" --path compatibilityProtocolPackage.actions.0.actionId --equals "http.info"
assert_json_field "$RESOLVED_MODEL" --path compatibilityProtocolPackage.actions.0.kind --equals "http"
assert_json_field "$RESOLVED_MODEL" --path compatibilityProtocolPackage.actions.2.kind --equals "websocket"
assert_json_field "$RESOLVED_MODEL" --path compatibilityProtocolPackage.actions.0.websocket --missing "true"
...
assert_json_field "$INVALID_METHOD_RESPONSE" --path routePathPrefix --equals "/echo"
assert_json_field "$INVALID_METHOD_RESPONSE" --path actionId --equals "http.echo"
assert_json_field "$INVALID_METHOD_RESPONSE" --path routeActionKind --equals "http"
assert_json_field "$INVALID_METHOD_RESPONSE" --path routeDispatchMode --equals "http_handler"
...
test "$WS_INVALID_METHOD_STATUS" = "405"
assert_json_field "$WS_INVALID_METHOD_RESPONSE" --path error --equals "method_not_allowed"
assert_json_field "$WS_INVALID_METHOD_RESPONSE" --path schemaVersion --equals "hardess.workerd.worker-error.v1"
assert_json_field "$WS_INVALID_METHOD_RESPONSE" --path dispatchSource --equals "worker_runtime"
assert_json_field "$WS_INVALID_METHOD_RESPONSE" --path routeId --equals "route.demo.workerd.ws"
assert_json_field "$WS_INVALID_METHOD_RESPONSE" --path routePathPrefix --equals "/ws"
assert_json_field "$WS_INVALID_METHOD_RESPONSE" --path actionId --equals "ws.echo"
assert_json_field "$WS_INVALID_METHOD_RESPONSE" --path routeActionKind --equals "websocket"
assert_json_field "$WS_INVALID_METHOD_RESPONSE" --path routeDispatchMode --equals "websocket_builtin"
assert_json_field "$WS_INVALID_METHOD_RESPONSE" --path allowedMethods --includes "GET"
assert_json_field "$WS_INVALID_METHOD_RESPONSE" --path workerRuntime.requestSequence --equals-json "5"
assert_json_field "$WS_INVALID_METHOD_RESPONSE" --path workerRuntime.totalRequests --equals-json "5"
assert_json_field "$WS_INVALID_METHOD_RESPONSE" --path workerRuntime.routeHitCount --equals-json "1"
assert_json_field "$WS_INVALID_METHOD_RESPONSE" --path workerRuntime.routeHits.2.routeId --equals "route.demo.workerd.ws"
assert_json_field "$WS_INVALID_METHOD_RESPONSE" --path workerRuntime.routeHits.2.count --equals-json "1"
...
assert_json_field "$WS_UPGRADE_REQUIRED_RESPONSE" --path workerRuntime.requestSequence --equals-json "6"
assert_json_field "$WS_UPGRADE_REQUIRED_RESPONSE" --path workerRuntime.totalRequests --equals-json "6"
assert_json_field "$WS_UPGRADE_REQUIRED_RESPONSE" --path workerRuntime.routeHitCount --equals-json "2"
assert_json_field "$WS_UPGRADE_REQUIRED_RESPONSE" --path workerRuntime.routeHits.2.routeId --equals "route.demo.workerd.ws"
assert_json_field "$WS_UPGRADE_REQUIRED_RESPONSE" --path workerRuntime.routeHits.2.count --equals-json "2"
...
assert_json_field "$WS_RESPONSE" --path workerRuntime.requestSequence --equals-json "7"
assert_json_field "$WS_RESPONSE" --path workerRuntime.totalRequests --equals-json "7"
assert_json_field "$WS_RESPONSE" --path workerRuntime.routeHitCount --equals-json "3"
assert_json_field "$WS_RESPONSE" --path workerRuntime.routeHits.2.routeId --equals "route.demo.workerd.ws"
assert_json_field "$WS_RESPONSE" --path workerRuntime.routeHits.2.count --equals-json "3"
...
assert_json_field "$RUNTIME_RESPONSE" --path routes.0.routeDispatchMode --equals "http_handler"
...
assert_json_field "$RUNTIME_RESPONSE" --path workerRuntime.requestSequence --equals-json "8"
assert_json_field "$RUNTIME_RESPONSE" --path workerRuntime.totalRequests --equals-json "8"
...
assert_json_field "$RUNTIME_RESPONSE" --path workerRuntime.routeHits.2.count --equals-json "3"
...
assert_json_field "$RUNTIME_STATS_RESPONSE" --path workerRuntime.requestSequence --equals-json "9"
assert_json_field "$RUNTIME_STATS_RESPONSE" --path workerRuntime.totalRequests --equals-json "9"
...
assert_json_field "$RUNTIME_ROUTES_RESPONSE" --path routes.1.routeDispatchMode --equals "http_handler"
assert_json_field "$RUNTIME_ROUTES_RESPONSE" --path routes.2.routeDispatchMode --equals "websocket_builtin"
assert_json_field "$RUNTIME_ROUTES_RESPONSE" --path routes.0.pathPrefix --missing "true"
assert_json_field "$RUNTIME_ROUTES_RESPONSE" --path routes.0.actionKind --missing "true"
assert_json_field "$RUNTIME_ROUTES_RESPONSE" --path routes.0.dispatchMode --missing "true"
assert_json_field "$RUNTIME_ROUTES_RESPONSE" --path routes.2.routeId --equals "route.demo.workerd.ws"
assert_json_field "$RUNTIME_ROUTES_RESPONSE" --path workerRuntime.requestSequence --equals-json "10"
assert_json_field "$RUNTIME_ROUTES_RESPONSE" --path workerRuntime.totalRequests --equals-json "10"
...
assert_json_field "$RUNTIME_INVALID_METHOD_RESPONSE" --path workerRuntime.requestSequence --equals-json "11"
assert_json_field "$RUNTIME_INVALID_METHOD_RESPONSE" --path workerRuntime.totalRequests --equals-json "11"
...
assert_json_field "$RUNTIME_NOT_FOUND_RESPONSE" --path workerRuntime.requestSequence --equals-json "12"
assert_json_field "$RUNTIME_NOT_FOUND_RESPONSE" --path workerRuntime.totalRequests --equals-json "12"
